...
#################################################################################################
# 
# This script contains the code for analyzing the 2019 New York City taxi data. Please note 
# that the parquet file is not stored in the repo so this script will not be able to run 
# unless one downloads the data from the NYC website (see format_raw_nyc_data.R script).
#
#################################################################################################
